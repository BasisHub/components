...
public class ResultSetJsonMapper {
	...
	public static String toJson(List<DataRow> dataRows, List<HashMap<String, Object>> metaData, boolean meta,
		...
		for (DataRow dr : dataRows) {
			...
			if (meta) {
				metaDone = writeMeta(metaData, addIndexColumn, jsonGenerator, metaDone, dr);
			}
	...
	private static boolean writeMeta(List<HashMap<String, Object>> metaData, String addIndexColumn, JsonGenerator jsonGenerator, boolean metaDone, DataRow dr) throws IOException {
		if (!metaDone) {
