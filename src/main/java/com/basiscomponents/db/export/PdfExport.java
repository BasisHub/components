...
import com.basiscomponents.db.ResultSetExporter;
...
public class PdfExport {
	...
	private static String buildReport(SheetConfiguration sheetConfig, DataRow fieldTypes, ResultSet rs,
		...
		InputStream stream;
		if (landscapeMode) {
			stream = ResultSetExporter.class.getClassLoader().getResourceAsStream("pdfexport/baseReport_landscape.jrxml");
		} else {
			stream = ResultSetExporter.class.getClassLoader().getResourceAsStream("pdfexport/baseReport_portrait.jrxml");
		}
		...
		if (baristaMode) {
			stream = ResultSetExporter.class.getClassLoader().getResourceAsStream("pdfexport/baristaReport_header.txt");
